...
| Item | Value |
|------|--------|
| Bundle ID | `com.planetread.clickalignsubtitletool` |
| Bundle version | `2.0.0` |
| Panel extension ID | `com.planetread.clickalignsubtitletool.panel` (panel `Version` **2.0.0**) |
| Premiere host | `PPRO`, version range **`[25.0, 26.9]`** (25.x–26.x; Exchange rejects caps above Adobe’s registered maximum—if upload fails, lower the high bound or contact Adobe) |
...
| README vs manifest | Any **bundle ID** in user-facing docs should match **`com.planetread.clickalignsubtitletool`**. |
